...
| --- | ---: | ---: | ---: | --- |
| GitHub Actions default workflow settings | `6` | `+0 / ~0 / -0` | `+0 / -0` | [snapshot](../../data/latest/github-actions-default-workflow-settings.json) · [diff](../../data/diffs/2026-06-21/github-actions-default-workflow-settings.json) · [reverse index](../../data/reverse-index/github-actions-default-workflow-settings.json) |
| GitHub fine-grained PAT permissions | `72` | `+0 / ~0 / -0` | `+0 / -0` | [snapshot](../../data/latest/github-fgpat-permissions.json) · [diff](../../data/diffs/2026-06-21/github-fgpat-permissions.json) · [reverse index](../../data/reverse-index/github-fgpat-permissions.json) |
| GitHub GITHUB_TOKEN permissions | `17` | `+0 / ~0 / -0` | `+0 / -0` | [snapshot](../../data/latest/github-token-permissions.json) · [diff](../../data/diffs/2026-06-21/github-token-permissions.json) · [reverse index](../../data/reverse-index/github-token-permissions.json) |
