...
| --- | ---: | ---: | ---: | --- |
| Azure built-in roles | `498` | `+0 / ~0 / -0` | `+0 / -0` | [snapshot](../../data/latest/azure-built-in-roles.json) · [diff](../../data/diffs/2026-05-06/azure-built-in-roles.json) · [reverse index](../../data/reverse-index/azure-built-in-roles.json) |
