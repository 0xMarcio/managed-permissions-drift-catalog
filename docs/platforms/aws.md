...
| --- | ---: | ---: | ---: | --- |
| AWS managed policies | `1,536` | `+0 / ~0 / -0` | `+0 / -0` | [snapshot](../../data/latest/aws-managed-policies.json) · [diff](../../data/diffs/2026-07-15/aws-managed-policies.json) · [reverse index](../../data/reverse-index/aws-managed-policies.json) |
