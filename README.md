...
- Refreshed: May 4, 2026 · [daily report](docs/daily/2026-05-04.md)

## Platform overview

| Platform | Last 7 days | Last 30 days | Main recent driver |
| --- | --- | --- | --- |
| AWS | `+35` net · `+1` object · `~11` objects · `+35` atoms · 5 active days | `+155` net · `+1` object · `~28` objects · `+213` atoms · `-58` atoms · 11 active days | AWS managed policies (7d, last changed [May 3, 2026](data/diffs/2026-05-03/aws-managed-policies.json)) |
...
- Recent highlights: May 3, 2026: ~1 changed, +1 atoms (`AmazonCognitoUnAuthedIdentitiesSessionPolicy` (+1)); May 2, 2026: ~1 changed, +1 atoms (`SecurityAudit` (+1)); May 1, 2026: ~5 changed, +21 atoms (`AWSObservabilityAdminTelemetryEnablementServiceRolePolicy` (+11)).
