...
- Refreshed: June 7, 2026 · [daily report](docs/daily/2026-06-07.md)

## Platform overview

| Platform | Last 7 days | Last 30 days | Main recent driver |
| --- | --- | --- | --- |
| AWS | `+337` net · `+9` objects · `~21` objects · `+380` atoms · `-7` atoms · 3 active days | `+498` net · `+16` objects · `~67` objects · `+770` atoms · `-188` atoms · 20 active days | AWS managed policies (7d, last changed [June 7, 2026](data/diffs/2026-06-07/aws-managed-policies.json)) |
...
- Last 30 days: `+498` net · `+16` objects · `~67` objects · `+770` atoms · `-188` atoms · 20 active days.
